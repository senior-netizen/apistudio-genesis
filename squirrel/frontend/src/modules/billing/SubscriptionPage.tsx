...
export function SubscriptionPage() {
  const {
    ...
    subscriptionFeedback: state.subscriptionFeedback,
    clearSubscriptionFeedback: state.clearSubscriptionFeedback,
  }));
  ...
  const showLoadingSkeleton = loadingSubscription && !subscription && recentPayments.length === 0;

  return (
    <div className="space-y-12">
      <BillingStatusAlert feedback={subscriptionFeedback} onDismiss={clearSubscriptionFeedback} />
      {showLoadingSkeleton ? (
