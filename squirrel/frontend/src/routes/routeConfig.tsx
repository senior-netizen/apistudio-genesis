...
export const appRoutes: AppRoute[] = [
  ...
  },
  {
    ...
    summary: 'Founder and admin operations hub for monitoring, user management, and health.',
    adminOnly: true,
  },
  {
    id: 'founder-panel',
    ...
    summary:
      'Centralized operations center for founders and admins to monitor health, sessions, billing, and audit activity.',
    adminOnly: true,
  },
  {
    id: 'billing',
